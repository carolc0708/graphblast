#ifndef GRAPHBLAS_BLOCK_MATRIX_OPERATIONS_HPP_
#define GRAPHBLAS_BLOCK_MATRIX_OPERATIONS_HPP_

#include <vector>

#define __GRB_BACKEND_OPERATIONS_HEADER <graphblas/backend/__GRB_BACKEND_ROOT/block_matrix_operations.hpp>
...
Info vxm(Vector<W>*              w,
    ...
    // Case 1: u*A
    CHECK(checkDimRowSize(A,  u,    "A.nrows != u.size")); // in dimension.hpp, require function overload implemented
...
#endif // GRAPHBLAS_BLOCK_MATRIX_OPERATIONS_HPP_